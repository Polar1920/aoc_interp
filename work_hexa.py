...
for instruction in instructions:
    binary_value, hex_value = get_binary_value(instruction.strip())
    print(instruction.strip(), "equals to", hex_value)